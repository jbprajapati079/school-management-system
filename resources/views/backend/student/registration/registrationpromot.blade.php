        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title">Promot Student</h4>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            <form method="post" action="{{route('update.promot.student.registration',$data->student_id)}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="text-xs-right">
                                    <input type="submit" name="submit" id="" value="Promot" class="btn btn-rounded btn-success mb-5">
                                </div>
                            </form>
                        </div>
                    </div>
