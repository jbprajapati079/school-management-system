        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            <form method="post" action="{{route('update.student.shift',$editstudentshiftdata->id)}}">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="name" class="form-control" value="{{$editstudentshiftdata->name}}">
                                                @error('name')
